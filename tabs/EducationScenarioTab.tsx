            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 flex-grow">
             ...
             <div className="flex justify-between items-center mt-6">
              <div className="flex items-center gap-3">
                ...
                <button onClick={() => { const blob = new Blob([`Scenario: Education\nKey indicators generated.`], { type: 'text/plain' }); const url = URL.createObjectURL(blob); const a = document.createElement('a'); a.href = url; a.download = 'education-summary.txt'; a.click(); URL.revokeObjectURL(url); }} className="px-4 py-2 text-sm font-semibold text-gray-700 bg-white rounded-md border border-gray-200 hover:bg-gray-50">Download Summary</button>
              </div>
              <div className="flex items-center gap-3">
